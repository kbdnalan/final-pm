...
import { CheckCircle, XCircle, Trophy, Coins, ArrowLeft } from 'lucide-react';
...
interface Question {
  question: string;
  options: string[];
  correctAnswer: string; // Храним правильный ответ как строку
  explanation: string;
}
...
export function Quiz({ category, onComplete, onBack }: QuizProps) {
  ...
  useEffect(() => {
    ...
    if (category === 'mixed') {
      // Берем по несколько вопросов из каждой категории (НЕ ПЕРЕКРЫВАЮТСЯ)
          ...
          <div className="space-y-2 mb-6">
            <div className="flex items-center justify-center gap-2 p-3 bg-yellow-50 rounded-lg">
              ...
              <div className="text-left">
                <p className="text-sm font-medium">+{coinsEarned} монет</p>
